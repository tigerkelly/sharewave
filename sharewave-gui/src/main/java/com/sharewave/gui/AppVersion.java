 ...
 *      copies sharewave-gui.jar and VERSION into the same directory
 *      (/opt/sharewave/).
 *   2. <jar-dir>/../../VERSION          — running straight from a source
 *      checkout, e.g. java -jar sharewave-gui/target/sharewave-gui.jar,
 ...
 * rebuild, or edit /opt/sharewave/VERSION on an installed system.
 */
